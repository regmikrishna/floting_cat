...
::
::   Homepage: https://www.regmikrishna.com.np
::      Email: info@regmikrishna.com.np
::
::============================================================================
...
if not [%Act_OK%]==[1] (
echo.
echo In case of any issues, check https://www.regmikrishna.com.np/win_office/troubleshoot
)
...
echo           https://www.regmikrishna.com.np/win_office/KMS_VL_ALL_AIO
) else (
